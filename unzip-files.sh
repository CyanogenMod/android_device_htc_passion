...
unzip -j -o ../../../${DEVICE}_update.zip system/etc/01_qcomm_omx.cfg -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
...
unzip -j -o ../../../${DEVICE}_update.zip system/lib/libqcomm_omx.so -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
