...
adb pull /system/etc/AdieHWCodecSetting.csv ../../../vendor/htc/$DEVICE/proprietary/AdieHWCodecSetting.csv
...
adb pull /system/etc/vpimg ../../../vendor/htc/$DEVICE/proprietary/vpimg
